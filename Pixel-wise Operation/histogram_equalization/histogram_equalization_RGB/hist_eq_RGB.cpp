...
void hist_eq_Color(Mat &input, Mat &equalized, G(*trans_func)[3], float **CDF) {
	...
	//	// perform the transfer function
		...
		{
				equalized.at<Vec3b>(i, j)[0] = trans_func[(G)input.at<Vec3b>(i, j)[0]][0];
				equalized.at<Vec3b>(i, j)[1] = trans_func[(G)input.at<Vec3b>(i, j)[1]][1];
				equalized.at<Vec3b>(i, j)[2] = trans_func[(G)input.at<Vec3b>(i, j)[2]][2];
